...
public class ChatLog {
    ...
    // 1. Schauen ob es einen Logdatei für die 2 Chatmitglieder gibt; falls name des
    // Files sender und empfänger in beliebiger reihenfolge enthält
    // WENN JA
    ...
    // Methode 1 Partner & Sender vergleichen mit Textdateinamen; ob es die Datei
    // schon gibt. boolean --> Datei existiert ja / nein
    ...
    /*
     * private boolean doesFileExist (String filename, String sender_name, String
     * partner_name){
     * 
     * if(filename.contains(sender_name) && filename.contains(partner_name)){ return
 ...
 * FileReader(resourcesFilePath)); BufferedWriter writer =
 * Files.newBufferedWriter(outputFilePath, charset); ) { String line;
 * 
 * while ((line = br.readLine()) != null) { String repl =
 * line.replaceAll("Orange:(.*)","OrangeAndApples:$1"); writer.writeln(repl); }
 * }
 */