...
public class emojiFinder {
     ...
     * "🤷🏼‍♀️", "❤️", "👉", "🧞‍♂️", "😬", "😭", "🌚", "👈", "🤙", "👨", "🤣",
     * "👍", "😃", "😂", "💛", "🖤", "😄", "🌝", "😁", "☀️", "👎", "😜", "💯", "😉",
     * "😎", "🤓", "🥳" }; static String[] shortcuts = { ":relieved:", ":pray:",
     * ":violin:", ":angry:", ":monocle:", ":point_up:", ":ok:", ":angel:",
     * ":happy:", ":shush:", ":think:", ":money:", ":sweat:", ":love_eyes",
     * ":pensive:", ":fit:", ":broken_heart:", ":roling_eyes:", ":in_love:",
     * ":unhappy:", ":shruggin:", ":heart:", ":point_right", "‍:djinn:", ":grim:",
     * ":cry:", ":moon:", ":point_left:", ":call_me:", ":mustache:", ":rofl:",
     * ":thumb:", ":smile:", ":joy:", ":heart_yellow:", ":heart_black:",
     * "another_smile", "full_moon", ":grin:", ":sun:", ":thumb_down:",
     * ":tounge_out:", ":100:", ":wink:", ":sunglasses:", ":glasses:", ":party:" };
     */
    static String emojis[] = { "😄", "😃", "😀", "😊", "😉", "😍", "😘", "😚", "😗", "😙", "😜", "😝", "😛", "😳", "😁",
            "😔", "😌", "😒", "😞", "😣", "‍😢", "😂", "😭", "😪", "😥", "😰", "😅", "😓", "😩", "😫", "😨", "😱", "😠",
            "😡", "😤", "😖", "🤑", "😋", "😷", "😎", "😴", "😵", "😲", "😟", "😦", "😧", "😈" };
